// let pues al vaciar queremos asignarle un nuevo array
/* Otra opción sería dejarlo como const y luego en el botón vaciar poner:
    nombres.splice(0);
*/
let nombres = [];
...
document.getElementById('vaciar').addEventListener("click", eliminarNombres);
